...
exit_6:
  ...
  li t1, 0xc0026000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  li t1, 0xc0080000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_12:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0082000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_15:
  ...
  li t1, 0xc0081000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_19:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0083000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2412
  li t0, 0x9048                               # Load address into t0
  li t1, 0xc0014000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_22:
  ...
  li t1, 0xc0015000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_40:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0084000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_44:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0085000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_58:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0086000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_76:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0088000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_79:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0087000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_87:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0089000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_101:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc008a000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_119:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc008c000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_122:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc008b000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_130:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc008d000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_144:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc008e000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_162:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0094000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_165:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0090000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_173:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0091000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2412
  li t0, 0x9048                               # Load address into t0
  li t1, 0xc0012000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_187:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0092000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_191:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc0093000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_201:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc0098000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_219:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00a0000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_222:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc009c000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_230:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc009d000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_240:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00a4000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_254:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00a8000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_257:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc009e000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_265:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc009f000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_275:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00b0000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_289:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00c0000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_292:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc00ac000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_300:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc00ad000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2412
  li t0, 0x9048                               # Load address into t0
  li t1, 0xc0017000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_314:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00ae000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_318:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc00af000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_332:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00d0000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_354:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00e0000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_357:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc00b8000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_365:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc00b9000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_379:
  ...
  # actual addr: 0x0c1f
  li t0, 0x307c                               # Load address into t0
  li t1, 0xc00ba000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_394:
  ...
  # actual addr: 0x200b
  li t0, 0x802c                               # Load address into t0
  li t1, 0xc00bb000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
