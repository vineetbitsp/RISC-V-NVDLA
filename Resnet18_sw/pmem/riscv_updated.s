...
exit_6:
  ...
  li t1, 0xc0018000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  li t1, 0x00000035                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_19:
  ...
  # actual addr: 0x2c12
  li t0, 0xb048                               # Load address into t0
  li t1, 0xc0028000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_26:
  ...
  li t1, 0xc0038000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  li t1, 0x00007000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  li t1, 0xc003a000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_44:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0105000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2810
  li t0, 0xa040                               # Load address into t0
  li t1, 0x0000003a                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address

  # actual addr: 0x2811
  li t0, 0xa044                               # Load address into t0
  li t1, 0xc0020000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address

  # actual addr: 0x2812
  li t0, 0xa048                               # Load address into t0
  li t1, 0x00000000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address

  # actual addr: 0x2813
  li t0, 0xa04c                               # Load address into t0
  li t1, 0x00000400                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address

  # actual addr: 0x2814
  li t0, 0xa050                               # Load address into t0
  li t1, 0x00008000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_62:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc010a000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_80:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc010c000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_84:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc010b000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_98:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc010e000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_102:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0110000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_120:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0112000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_124:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0111000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_138:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0114000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_142:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0118000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_160:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0120000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_164:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0119000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2c12
  li t0, 0xb048                               # Load address into t0
  li t1, 0xc003c000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_182:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc011a000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_186:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc011b000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_204:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0128000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_208:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc011c000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_226:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0130000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_230:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc011d000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_244:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0138000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_248:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc011e000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_266:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0140000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_270:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc011f000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_284:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0150000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_288:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0148000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_306:
  ...
  # actual addr: 0x141b
  li t0, 0x506c                               # Load address into t0
  li t1, 0x0000047f                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc0160000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_310:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc0149000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2c12
  li t0, 0xb048                               # Load address into t0
  li t1, 0xc003e000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_324:
  ...
  # actual addr: 0x180d
  li t0, 0x6034                               # Load address into t0
  li t1, 0x00001000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc014a000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_328:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc014b000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_346:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc014c000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_364:
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc01a0000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_368:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc014d000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_382:
  ...
  # actual addr: 0x180d
  li t0, 0x6034                               # Load address into t0
  li t1, 0x00000500                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x141b
  li t0, 0x506c                               # Load address into t0
  li t1, 0x0000007f                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x141f
  li t0, 0x507c                               # Load address into t0
  li t1, 0xc014e000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_386:
  ...
  # actual addr: 0x280b
  li t0, 0xa02c                               # Load address into t0
  li t1, 0xc014f000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
  ...
  # actual addr: 0x2c12
  li t0, 0xb048                               # Load address into t0
  li t1, 0xc003b000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
...
exit_404:
  ...
  li t0, 0xc                                     # Load address into t0
  li t1, 0xffffffff                       # Load mask into t1
  li t2, 0x00280000                       # Load expected value into t2
  li t3, 0xffffffff                               # Load max iteration count into t3
loop_404:
  lw t4, 0(t0)                            # Load value from address
  and t4, t4, t1                          # Perform logical AND with mask
...
exit_405:
  ...
  # actual addr: 0x0003
  li t0, 0xc                                     # Load address into t0
  li t1, 0x00280000                       # Load data into t1
  sw t1, 0(t0)                            # Write data to address
